...
HD_PWD='/home/s652wang/s652wang-lab4/lab4_vivado/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mm.tcl
